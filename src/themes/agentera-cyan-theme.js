const n = `/*
 *     Typora Theme - AgentEra Cyan    /    Author - agent时代公众号
 *     Modern Tech Light Theme for AI Era with Neon Green Headings
 */

:root {
    /* Primary Tech Colors - Light Mode (Cyan-Green System) */
    --tech-primary: #00d9ff;
    --tech-secondary: #00ffa3;
    --tech-accent: #00e5cc;
    --tech-gradient-1: #00d9ff;
    --tech-gradient-2: #00ffa3;
    --tech-neon: #00ffcc;
    ...
    --bg-secondary: #f8f9fa;
    --bg-card: #f1f3f5;
    --bg-gradient: linear-gradient(135deg, #00d9ff15 0%, #00ffa315 100%);
    --text-primary: #212529;
    ...
    --gradient-tech: linear-gradient(90deg, #00d9ff 0%, #00ffa3 100%);
    --gradient-neon: linear-gradient(135deg, #00ffcc 0%, #00ffa3 100%);
    --gradient-purple: linear-gradient(135deg, #00e5cc 0%, #00d9ff 100%);

    /* Border & Shadow */
    --border-tech: 1px solid rgba(0, 217, 255, 0.2);
    --shadow-primary: 0 4px 12px rgba(0, 217, 255, 0.15);
    --shadow-tech: 0 2px 8px rgba(0, 217, 255, 0.1);
    --glow-heading: 0 0 20px rgba(0, 217, 255, 0.3);
}
...
#wenyan blockquote {
    ...
    text-indent: 0;
    border: none;
    background: linear-gradient(135deg, rgba(0, 217, 255, 0.05) 0%, rgba(0, 255, 163, 0.05) 100%);
...
#wenyan p code {
    ...
    border-radius: 6px;
    font-weight: 500;
    box-shadow: 0 2px 4px rgba(0, 217, 255, 0.08);
}
