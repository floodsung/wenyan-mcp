const n = `/*
 *     Typora Theme - AgentEra Blue    /    Author - agent时代公众号
 *     Modern Tech Light Theme for AI Era with Cool Blue-Purple Headings
 */

:root {
    /* Primary Tech Colors - Light Mode (Blue-Purple System) */
    --tech-primary: #4a90e2;
    --tech-secondary: #667eea;
    --tech-accent: #5a9ff5;
    --tech-gradient-1: #4a90e2;
    --tech-gradient-2: #667eea;
    --tech-neon: #7da3f7;
    ...
    --bg-secondary: #f8f9fa;
    --bg-card: #f1f3f5;
    --bg-gradient: linear-gradient(135deg, #4a90e215 0%, #667eea15 100%);
    --text-primary: #212529;
    ...
    --gradient-tech: linear-gradient(90deg, #4a90e2 0%, #667eea 100%);
    --gradient-neon: linear-gradient(135deg, #7da3f7 0%, #667eea 100%);
    --gradient-purple: linear-gradient(135deg, #5a9ff5 0%, #4a90e2 100%);

    /* Border & Shadow */
    --border-tech: 1px solid rgba(74, 144, 226, 0.2);
    --shadow-primary: 0 4px 12px rgba(74, 144, 226, 0.15);
    --shadow-tech: 0 2px 8px rgba(74, 144, 226, 0.1);
    --glow-heading: 0 0 20px rgba(74, 144, 226, 0.3);
}
