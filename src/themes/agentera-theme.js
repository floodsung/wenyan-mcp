const n = `/*
 *     Typora Theme - AgentEra Light    /    Author - agent时代公众号
 *     Modern Tech Light Theme for AI Era with Cool Headings
 */

:root {
    /* Primary Tech Colors - Light Mode (Warm Orange-Gold System) */
    --tech-primary: #ff6b35;
    --tech-secondary: #f7931e;
    --tech-accent: #ff8c42;
    --tech-gradient-1: #ff6b35;
    --tech-gradient-2: #ffa500;
    --tech-neon: #ffb347;
    ...
    --bg-secondary: #f8f9fa;
    --bg-card: #f1f3f5;
    --bg-gradient: linear-gradient(135deg, #ff6b3515 0%, #ffa50015 100%);
    --text-primary: #212529;
    ...
    --gradient-tech: linear-gradient(90deg, #ff6b35 0%, #f7931e 100%);
    --gradient-neon: linear-gradient(135deg, #ffb347 0%, #f7931e 100%);
    --gradient-purple: linear-gradient(135deg, #ff8c42 0%, #ff6b35 100%);

    /* Border & Shadow */
    --border-tech: 1px solid rgba(255, 107, 53, 0.2);
    --shadow-primary: 0 4px 12px rgba(255, 107, 53, 0.15);
    --shadow-tech: 0 2px 8px rgba(255, 107, 53, 0.1);
    --glow-heading: 0 0 20px rgba(255, 107, 53, 0.3);
}
