const n = `/*
 *     Typora Theme - AgentEra Mint    /    Author - agent时代公众号
 *     Modern Tech Light Theme for AI Era with Mint Fresh Headings
 */

:root {
    /* Primary Tech Colors - Light Mode (Mint Fresh System) */
    --tech-primary: #43e97b;
    --tech-secondary: #38f9d7;
    --tech-accent: #4ade80;
    --tech-gradient-1: #43e97b;
    --tech-gradient-2: #38f9d7;
    --tech-neon: #5eead4;
    ...
    --bg-secondary: #f8f9fa;
    --bg-card: #f1f3f5;
    --bg-gradient: linear-gradient(135deg, #43e97b15 0%, #38f9d715 100%);
    --text-primary: #212529;
    ...
    --gradient-tech: linear-gradient(90deg, #43e97b 0%, #38f9d7 100%);
    --gradient-neon: linear-gradient(135deg, #5eead4 0%, #38f9d7 100%);
    --gradient-purple: linear-gradient(135deg, #4ade80 0%, #43e97b 100%);

    /* Border & Shadow */
    --border-tech: 1px solid rgba(67, 233, 123, 0.2);
    --shadow-primary: 0 4px 12px rgba(67, 233, 123, 0.15);
    --shadow-tech: 0 2px 8px rgba(67, 233, 123, 0.1);
    --glow-heading: 0 0 20px rgba(67, 233, 123, 0.3);
}
...
#wenyan p code {
    ...
    border-radius: 6px;
    font-weight: 500;
    box-shadow: 0 2px 4px rgba(67, 233, 123, 0.08);
}
