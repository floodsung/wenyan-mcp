const n = `/*
 *     Typora Theme - AgentEra Rose    /    Author - agent时代公众号
 *     Modern Tech Light Theme for AI Era with Rose Gold Headings
 */

:root {
    /* Primary Tech Colors - Light Mode (Rose Gold System) */
    --tech-primary: #ff6b9d;
    --tech-secondary: #ffa07a;
    --tech-accent: #ff85a1;
    --tech-gradient-1: #ff6b9d;
    --tech-gradient-2: #ffa07a;
    --tech-neon: #ffb3ba;
    ...
    --bg-secondary: #f8f9fa;
    --bg-card: #f1f3f5;
    --bg-gradient: linear-gradient(135deg, #ff6b9d15 0%, #ffa07a15 100%);
    --text-primary: #212529;
    ...
    --gradient-tech: linear-gradient(90deg, #ff6b9d 0%, #ffa07a 100%);
    --gradient-neon: linear-gradient(135deg, #ffb3ba 0%, #ffa07a 100%);
    --gradient-purple: linear-gradient(135deg, #ff85a1 0%, #ff6b9d 100%);

    /* Border & Shadow */
    --border-tech: 1px solid rgba(255, 107, 157, 0.2);
    --shadow-primary: 0 4px 12px rgba(255, 107, 157, 0.15);
    --shadow-tech: 0 2px 8px rgba(255, 107, 157, 0.1);
    --glow-heading: 0 0 20px rgba(255, 107, 157, 0.3);
}
...
#wenyan p code {
    ...
    border-radius: 6px;
    font-weight: 500;
    box-shadow: 0 2px 4px rgba(255, 107, 157, 0.08);
}
